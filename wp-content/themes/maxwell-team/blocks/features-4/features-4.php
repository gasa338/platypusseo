...
<section id="<?php echo esc_attr($anchor); ?>" class="<?php echo esc_attr($color_mode == 'dark' ? 'bg-hero' : ''); ?> relative overflow-hidden features-4-<?php echo esc_attr($blocks_id); ?> <?php echo esc_attr($blocks_class); ?>">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="grid lg:grid-cols-2 gap-6 lg:gap-20 items-center lg:flex-row-reverse">
            ...
            <div class="<?php echo esc_attr($reverse == 'yes' ? 'order-2' : 'order-1'); ?>">
                ...
                <?php if (!empty($data['text'])): ?>
                    <div class="<?php echo esc_attr($color_mode == 'dark' ? 'text-white/60 [&_li]:!text-white [&_span]:!text-white [&_strong]:!text-white' : 'text-muted-foreground [&_li]:!text-foreground [&_span]:!text-muted-foreground [&_strong]:!text-muted-foreground'); ?> text-lg leading-relaxed maxwell-content"><?php echo apply_filters('the_content', $data['text']); ?></div>
                <?php endif; ?>
