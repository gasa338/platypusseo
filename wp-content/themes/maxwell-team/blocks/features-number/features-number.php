...
<section class="py-24 bg-section-light <?php echo $blocks_class; ?>">
    <div class="container mx-auto px-6">
        <div style="opacity: 1;"><span class="text-primary text-sm font-medium tracking-wider uppercase mb-4 block text-center" style="opacity: 1; transform: none;">Why Us</span>
            <h2 class="font-display text-4xl md:text-5xl font-bold mb-16 text-foreground text-center" style="opacity: 1; transform: none;">Consistent Results <span class="text-primary">Across Industries</span></h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center p-8 rounded-2xl bg-card border border-border hover:border-primary/30 transition-colors" style="opacity: 1; transform: none;">
                    ...
                    <div class="font-display text-4xl font-bold text-gradient mb-3">340%</div>
                ...
                <div class="text-center p-8 rounded-2xl bg-card border border-border hover:border-primary/30 transition-colors" style="opacity: 1; transform: none;">
                    ...
                    <div class="font-display text-4xl font-bold text-gradient mb-3">180%</div>
                ...
                <div class="text-center p-8 rounded-2xl bg-card border border-border hover:border-primary/30 transition-colors" style="opacity: 1; transform: none;">
                    ...
                    <div class="font-display text-4xl font-bold text-gradient mb-3">45%</div>
                ...
                <div class="text-center p-8 rounded-2xl bg-card border border-border hover:border-primary/30 transition-colors" style="opacity: 1; transform: none;">
                    ...
                    <div class="font-display text-4xl font-bold text-gradient mb-3">12x</div>
